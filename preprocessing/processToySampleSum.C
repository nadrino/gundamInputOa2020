...
//    ,{"run2w_throw_splines.root", "run2wMCsplines.root"} // missing toy file
    ,{"run3_throw_splines.root", "run3MCsplines.root"}
    ,{"run4w_throw_splines.root", "run4wMCsplines.root"}
//    ,{"run6_throw_splines.root", "run6MCsplines.root"} // mismatch
    ,{"run7_throw_splines.root", "run7MCsplines.root"}
//    ,{"run8a_throw_splines.root", "run8aMCsplines.root"} // missing toy file
